...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
		<!--Logo y boton movil que agrupa el contenido-->
		<div class="navbar-header">
			<button type="botton" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse1">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Comunidad <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
